...
//Bluetooth APP, aircraft model controller, serial port 1, serial port 5 communication control flag bit.
//These 4 flag bits are all 0 by default, representing the serial port 3 control mode
//蓝牙APP、航模手柄、串口1、串口5通信控制标志位。这4个标志位默认都为0，代表串口3控制模式
u8 APP_ON_Flag=0, Remote_ON_Flag=0, Usart1_ON_Flag, Usart5_ON_Flag; 
